<div class="div">
    ...
    <div class="container ">
        ...
        <div class="post-body">
            <div class="col-md-6" style="width: 450px">
                <div class="shadow-md p-3 " id="write">
                    <button class="write-2 form-control" style="color:black;background-color: #gray;" data-toggle="modal" data-target="#click">+ Create New</button>
                </div>
            </div>
            ...
            <div class="col-md-12  offset-1">
                ...
                <div class="card shadow-md mt-3 {{ $post->user->gender === 'Female' ? 'f1' : 'm1' }}"  style="width: 900px">
                    <div class="card-header">
                        @if($post->isEditable())
                        <span id="dot-icon" class="float-end dropdown dropstart bg-black">
                    ...
                    <div class="card-footer">
                        ...
                        <img class="card" style="border-radius: 100%; width: 200px;" id="pf1"
                        src="{{ $post->user->gender === 'Male' ? asset('images/boy.png') : asset('images/girl.png') }}"
                        alt="photo">
        ...
        @if($posts->isEmpty())
            <div style="color: red">
                <h1 class="text-center mt-4" style="font-size: 50px;">No posts.</h1>
            </div>
        @endif
